$(function () {
    ...
    function movimentarCobra() {
        ...
        $(document).keydown(function (e) {
            if ((e.keyCode == 87  || e.keyCode == 38) && direcao != "S")
                newDirecao = "W";
            else if ((e.keyCode == 68 || e.keyCode == 39) && direcao != "A")
                newDirecao = "D";
            else if ((e.keyCode == 83 || e.keyCode == 40) && direcao != "W")
                newDirecao = "S";
            else if ((e.keyCode == 65 || e.keyCode == 37 )&& direcao != "D")
                newDirecao = "A";
        });
